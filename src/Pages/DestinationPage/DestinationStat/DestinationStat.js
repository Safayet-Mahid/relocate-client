...
const DestinationStat = ({ city }) => {
    const { featuredImage1, featuredImage2, featuredImage3, stat1, stat4, population, safety, weather } = city;
    // const { rent, groceries, others, total } = stat4;
            ...
            <div className='mx-12'>
                <div className='flex border rounded-md justify-between p-3 text-left mb-9' >
                    ...
                    <div className=' p-2 flex-1'>
                        ...
                        <div className='flex items-center'>
                            ...
                            <p className='font-bold mx-2'>{safety}</p>
                        </div>
                    </div>
                ...
                <div className='grid grid-cols-2 grid-rows-2 gap-4 w-full  featured-photo '>
                    <div className='col-span-2'>
                        <img className='w-full rounded-lg' src={featuredImage1} alt="" />
                    </div>
                    <div>
                        <img className='w-full rounded-lg' src={featuredImage2} alt="" />
                    </div>
                    <div>
                        <img className='w-full rounded-lg' src={featuredImage3} alt="" />
                    </div>
                </div>
                ...
                <div className='flex border rounded-md justify-between p-3 text-left mt-3' >
                    ...
                    <div className=' p-4 flex-1 ' style={{ borderRight: ".25px solid #ddd" }}>
                        <h6 className='font-bold mb-3 text-xl' style={{ color: " rgba(0, 0, 0, 0.4)" }}>OTHERS</h6>
                        <div className='flex my-2 '>
                    ...
                    <div className=' p-4 flex-1'>
                        <h6 className='font-bold mb-3 text-xl' style={{ color: " rgba(0, 0, 0, 0.4)" }}>TOTAL</h6>
                        <div className='flex my-2 '>
